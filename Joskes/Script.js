let jock = [
    `hat do you call a boomerang that won’t come back ?        A stick.`,
    `hat does a cloud wear under his raincoat ?    Thunderwear.`,
    `wo pickles fell out of a jar onto the floor.What did one say to the other ?    Dill with it.`,
    `hat time is it when the clock strikes 13 ?    Time to get a new clock.`,
    `ow does a cucumber become a pickle ?    It goes through a jarring experience.`,

  `hat did one toilet say to the other ?    You look a bit flushed.`,
    `hat do you think of that new diner on the moon ?    Food was good, but there really wasn’t much atmosphere.`,
    `hy did the dinosaur cross the road ?    Because the chicken wasn’t born yet.`,
    `hy can’t Elsa from Frozen have a balloon ?    Because she will "let it go, let it go."`,
  ...
  `How does a scientist freshen her breath ?    With experi - mints.`,
    ...
    `What did the little corn say to the mama corn ?    Where is pop corn ?        34. How do you make a lemon drop ?            Just let it fall.`,
...
document.getElementsByClassName("jocks")[0].innerHTML = document.getElementsByClassName("jocks")[0].innerHTML + jock[r];
// document.querySelectorAll(".jocks")[0].innerHTML = `<h3>${jock[r]}</h3>`
document.querySelectorAll(".jocks")[0].style.color = "skyblue"
// document.querySelectorAll(".jocks")[0].style.fontsize = "50px";
// document.querySelectorAll(".jocks")[0].style.background = "yellow";
